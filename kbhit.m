        ...
        switch lower(cmd)
            case 'init'
                try
                    ...
                    javastr_press = ['global KBHIT_h_cw; ' ...
                               'set(KBHIT_h_cw,''Userdata'', get(gcbo, ''KeyPressedCallbackData'')); '...
                               'clear KBHIT_h_cw; ' ...
                               ];
                    javastr_release = ['global KBHIT_h_cw; ' ...
                               'set(KBHIT_h_cw,''Userdata'', get(gcbo, ''KeyReleasedCallbackData'')); '...
                               'clear KBHIT_h_cw; ' ...
                               ];
                    set(KBHIT_h_cw_cbp, 'KeyReleasedCallback', javastr_release);
                    set(KBHIT_h_cw_cbp, 'KeyPressedCallback', javastr_press);
